...
public class CropImage extends JFrame
{
    ...
    public void loadImage()
    {
        ...
        try
        {
            backgroundImage = ImageIO.read( new File( "classpath:static/eye.jpg" ) );
            tracker.addImage( backgroundImage, 0 );

            maskImage = ImageIO.read( new File( "classpath:static/eye.jpg" ) );
            tracker.addImage( maskImage, 1 );

            sourceImage = ImageIO.read( new File( "classpath:static/eye.jpg" ) );
    ...
    public void setResultImage( Image source, Image mask )
    {
        ...
        {
            //保存图片
            ImageIO.write( rImage, "png", new File( "C:/Users/mengq/Desktop/new.jpg" ) );
        }
        catch (IOException e)
        {
            e.printStackTrace();
