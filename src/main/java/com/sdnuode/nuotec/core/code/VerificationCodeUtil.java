...
//        Graphics2D graphics2D = (Graphics2D) image.getGraphics();//强制向上转型SunGraphics2D->Graphics2D,使用实际上是用的SunGraphics2D的实例方法
...
//            drawRandomString((Graphics2D)g,String.valueOf(randomString.charAt(j)), j);
        }
        //= ?
