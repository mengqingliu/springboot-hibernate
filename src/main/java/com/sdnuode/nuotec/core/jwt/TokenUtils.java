package com.sdnuode.nuotec.core.jwt;
...
public class TokenUtils {
    ...
    private static final byte[] secret = "geiwoyigewenkeyibukeyifeiwenyemeiguanxi".getBytes();
...
//        解析token
    ...
    //生成token的业务逻辑
    public static String tokenModel(String uid) {
        //获取生成token
